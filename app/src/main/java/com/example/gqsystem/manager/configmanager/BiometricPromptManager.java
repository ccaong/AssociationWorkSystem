...
import static com.example.gqsystem.config.Constants.HawkCode.KEY_BIOMETRIC_SWITCH_ENABLE;
...
public class BiometricPromptManager {
    ...
    public boolean isBiometricSettingEnable() {
        ...
        return Hawk.get(KEY_BIOMETRIC_SWITCH_ENABLE, false);
    }
    ...
    public void setBiometricSettingEnable(boolean enable) {
        Hawk.put(KEY_BIOMETRIC_SWITCH_ENABLE, enable);
    }
}
